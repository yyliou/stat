...
**Step 3b:** $\bar{X}_{GM} = \dfrac{152}{18} \approx 8.444$

**Step 3c:** $s_B^2 = \dfrac{6(15.5-8.444)^2 + 6(4.0-8.444)^2 + 6(5.833-8.444)^2}{2} = \dfrac{458.11}{2} = 229.06$

**Step 3d:** $s_W^2 = \dfrac{5(81.9) + 5(25.6) + 5(28.97)}{15} = \dfrac{682.33}{15} = 45.49$

**Step 3e:** $F = \dfrac{229.06}{45.49} = 5.035$

**Step 4:** $5.035 > 3.68$ → **Reject** $H_0$
...
| Source | SS | d.f. | MS | F |
|--------|-----|------|-----|---|
| Between | 458.11 | 2 | 229.06 | **5.035** |
| Within (Error) | 682.33 | 15 | 45.49 | |
| **Total** | **1140.44** | **17** | | |

**P-value:** $0.01 < P < 0.025$ (from F-tables); calculator: $P = 0.021$

Since $F = 5.035 > 3.68$, we **reject** $H_0$.
:::
...
:::{.callout-warning}
## Scheffé Test for Blood Pressure Data
...
:::{.callout-warning}
## Tukey Test for Blood Pressure Data
...
A **$2 \times 2$ design** has 2 levels for each factor → 4 treatment groups.

Example: Plant food type (A1, A2) $\times$ Soil type (I, II) → 4 groups
:::
...
| Interaction $A \times B$ | SS($A \times B$) | $(a-1)(b-1)$ | MS($A \times B$) | $F_{A \times B} = MS(A \times B)/MSW$ |
...
| Interaction $A \times B$ | 54.080 | 1 | 54.080 | **65.552** |
...
**Interaction $A \times B$:** $F_{A \times B} = 65.552 > 7.71$ → **Reject** $H_0$
