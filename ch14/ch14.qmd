...
**Example:** Random block 857236 → ignore 8, roll 5, ignore 7, roll 2, roll 3, **roll 6** → **4 rolls** (5, 2, 3, 6)
...
p148 <- ggplot(data.frame(value = many_draws), aes(x = factor(value))) +
...
```{r e14-8-3, echo=T, warning=FALSE, out.width="80%", fig.align='center', fig.height=3.0}
p148
```
:::
