    ...
    Reveal.on('ready', function() {
      ...
      if (title) {
        title.insertAdjacentHTML('beforeend',
          ...
          '<a href="ch14-zh.html" target="_blank" style="color:#555;">[中文版由此去]</a>' +
          '</p>');
      }
    });
    </script>
...
## Example 14-5: Tennis Game Simulation
...
## Example 14-6: Rolling a Die Until a 6 Appears
...
## Example 14-6: Visualization

```{r ex14-6-plot, echo=T, warning=FALSE}
set.seed(55)
...
## Example 14-8: Visualization

```{r ex14-8-plot, echo=T, warning=FALSE}
set.seed(33)
