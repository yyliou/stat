...
# Chapter 7: Confidence Intervals and Sample Size {background-color="#2c4a6e"}
...
**Assumptions:** (1) Random sample; (2) n ≥ 30, OR population is normally distributed if n < 30.
...
```{r t-dist-plot, echo=T, warning=FALSE}
...
```{r chisq-plot, echo=T, warning=FALSE}
