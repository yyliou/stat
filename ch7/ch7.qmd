...
(2) n ≥ 30, OR population is normally distributed if n < 30.
...
## Example 7-1: Days It Takes to Sell an Aveo {.smaller}
...
## Example 7-2: Waiting Times in Emergency Rooms {.smaller}
...
## Example 7-3: Credit Union Assets {.smaller}
...
**Answer:** $6.752 < \mu < 15.430$ million. We are 90% confident that the mean assets of all credit unions in this region fall between \$6.752M and \$15.430M.
...
## Example 7-4: Depth of a River {.smaller}
...
::: {.callout-important}
## Decision Rule
- **σ is known** → use $z_{\alpha/2}$ with σ in the formula (any n, if normal or n ≥ 30)
- **σ is unknown** → use $t_{\alpha/2}$ with s in the formula (normal population or n ≥ 30)
:::
...
## Example 7-6: Sleeping Time {.smaller}
...
## Example 7-7: Home Fires Started by Candles {.smaller}
...
## Example 7-8: Air-Conditioned Households {.smaller}
...
## Example 7-9: Covering College Costs {.smaller}
...
## Example 7-10: Religious Books {.smaller}
...
**Answer:** We are 95% confident the true percentage is between **14.2%** and **17.6%**.
...
## Example 7-11: Home Computers {.smaller}
...
## Example 7-12: M&M Colors {.smaller}
...
## Example 7-13: Finding Chi-Square Critical Values {.smaller}
...
## Example 7-14: Nicotine Content {.smaller}
...
## Example 7-15: Cost of Ski Lift Tickets {.smaller}
