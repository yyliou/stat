...
The frequency distribution reveals that **Type O** is the most common blood type in this sample, occurring 9 times (36%). **Type A** appears 5 times (20%), **Type B** appears 7 times (28%), and **Type AB** appears 4 times (16%).

```{r e2-1-2, echo=T, warning=FALSE, out.width="50%", fig.align='center'}
...
The record high temperatures ($^\circ$F) for each of the 50 U.S. states are listed below. Construct a grouped frequency distribution using 7 classes.
...
```{r e2-2-4, echo=T, warning=FALSE, out.width="65%", fig.align='center'}
...
```{r e2-3-1, echo=T, warning=FALSE, out.width="80%", fig.align='center'}
...
```{r e2-3-2, echo=T, warning=FALSE, out.width="80%", fig.align='center'}
...
```{r e2-3-3, echo=T, warning=FALSE, out.width="80%", fig.align='center'}
...
```{r e2-3-4, echo=T, warning=FALSE, out.width="80%", fig.align='center'}
...
:::{.callout-warning}
## Histogram of Record High Temperatures

Using the frequency distribution from [Example 2-2](#example-2-2), draw a histogram for the record high temperatures of the 50 U.S. states.
:::
---

**Solution** (R)

```{r e2-4-1, echo=T, warning=FALSE, out.width="80%", fig.align='center'}
ggplot(data.frame(temps), aes(x = temps)) +
...
Draw a frequency polygon for the record high temperatures data from [Example 2-2](#example-2-2).
:::
---
...
:::{.callout-warning}
## Ogive for Record High Temperatures

Draw an ogive for the record high temperatures distribution from [Example 2-2](#example-2-2).
:::
---

**Solution** (R)

```{r e2-6-1, echo=T, warning=FALSE, out.width="80%", fig.align='center'}
...
```{r e2-6-2, echo=T, warning=FALSE, out.width="80%", fig.align='center'}
...
:::{.callout-warning}
## Relative Frequency Graphs — Miles Run per Week
...
```{r e2-7-1, echo=T, warning=FALSE, out.width="80%", fig.align='center'}
run_df <- data.frame(
...
```{r e2-7-2, echo=T, warning=FALSE, out.width="80%", fig.align='center'}
...
```{r e2-7-6, echo=T, warning=FALSE, out.width="80%", fig.align='center'}
p3 <- ggplot(
  data.frame(
...
```{r e2-7-3, echo=T, warning=FALSE, out.width="80%", fig.align='center'}
...
```{r e2-7-4, echo=T, warning=FALSE, out.width="80%", fig.align='center'}
set.seed(42)
...
```{r e2-7-7, echo=T, warning=FALSE, out.width="80%", fig.align='center'}
...
```{r e2-7-5, echo=T, warning=FALSE, out.width="80%", fig.align='center'}
...
```{r e2-8-1, echo=T, warning=FALSE, out.width="80%", fig.align='center'}
spending <- data.frame(
...
```{r e2-8-2, echo=T, warning=FALSE, out.width="80%", fig.align='center'}
...
:::{.callout-warning}
## Homeless Population in Five Cities
...
```{r e2-9-1, echo=T, warning=FALSE, out.width="80%", fig.align='center'}
homeless <- data.frame(
...
```{r e2-9-2, echo=T, warning=FALSE, out.width="80%", fig.align='center'}
...
```{r e2-10-1, echo=T, warning=FALSE, out.width="80%", fig.align='center'}
...
```{r e2-10-2, echo=T, warning=FALSE, out.width="80%", fig.align='center'}
fig
```
...
$$\text{Degrees} = \frac{f}{n} \times 360^\circ$$
...
:::{.callout-warning}
## Super Bowl Snack Food Preferences
...
```{r e2-11-1, echo=T, warning=FALSE, out.width="80%", fig.align='center'}
snacks <- data.frame(
...
```{r e2-11-2, echo=T, warning=FALSE, out.width="80%", fig.align='center'}
fig
```
...
```{r e2-12-1, echo=T, warning=FALSE, out.width="80%", fig.align='center'}
...
```{r e2-12-2, echo=T, warning=FALSE, out.width="80%", fig.align='center'}
fig
```
...
:::{.callout-warning}
## Cardiograms at an Outpatient Center
...
```{r e2-13-1, echo=T, warning=FALSE, out.width="80%", fig.align='center'}
...
:::{.callout-warning}
## Car Thefts — Stem and Leaf with Classes
...
```{r e2-14-1, echo=T, warning=FALSE, out.width="80%", fig.align='center'}
thefts <- c(
  52, 62, 51, 50, 69,
  58, 77, 66, 53, 57,
  75, 56, 55, 67, 73,
...
:::{.callout-warning}
## Tall Buildings in Atlanta and Philadelphia
...
```{r e2-15-1, echo=T, warning=FALSE, out.width="80%", fig.align='center'}
...
back_to_back(atlanta, philly, "Atlanta", "Philadelphia")
```
:::
...
$$\text{Degrees} = \frac{f}{n} \times 360^\circ \quad \text{(pie chart sector)}$$
:::
