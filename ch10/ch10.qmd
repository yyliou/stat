...
## Example 10-1: Car Rental Companies — Scatter Plot
...
## Example 10-2: Absences and Final Grades — Scatter Plot
...
## Example 10-3: Age and Wealth — Scatter Plot
...
## Example 10-4: Correlation for Car Rental Companies
...
## Example 10-6: Correlation for Age and Wealth
...
::: {.callout-tip}
Test whether the correlation r = 0.982 from Example 10-4 is significant at α = 0.05.
:::
...
::: {.callout-tip}
Using Table I, test the significance of r = −0.176 from Example 10-6 at α = 0.01.
:::
...
## Example 10-9: Regression Line for Car Rental Data
...
::: {.callout-tip}
Using the shortcut formula and the data from Example 10-12 (where Σy² = 42,186, Σy = 496, Σxy = 1778, a = 55.57, b = 8.13):
:::

$$s_{est} = \sqrt{\frac{42186 - 55.57(496) - 8.13(1778)}{6-2}} = \sqrt{\frac{42186 - 27562.72 - 14455.14}{4}} \approx \boxed{6.48}$$
