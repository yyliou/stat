...
|---------------|--------------------|------------|
| 86 $^\circ$F | degree | 85.5 – 86.5 $^\circ$F |
...
1. A patient's temperature, recorded as 38.6 $^\circ$C (nearest tenth of a degree)
...
- **Interval** — ordered with **meaningful, equal differences**, but **no true zero** (temperature in $^\circ$F or $^\circ$C, IQ scores).
...
| Interval | Yes | Yes | No | Temperature ($^\circ$C), IQ |
| Ratio | Yes | Yes | Yes | Height, weight, income |

A temperature of 0 $^\circ$C does not mean "no heat" — so 40 $^\circ$C is **not** "twice as hot" as 20 $^\circ$C (interval). But a weight of 0 kg means no weight, and 40 kg **is** twice 20 kg (ratio).
...
| 6. Temperatures ($^\circ$C) | Interval | 0 $^\circ$C is not "no temperature" |
