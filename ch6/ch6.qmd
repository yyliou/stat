...
## Example 6-1: Area to the Left of z {.smaller}
...
## Example 6-2: Area to the Right of z {.smaller}
...
## Example 6-3: Area Between Two z Values {.smaller}
...
## Example 6-4: Multiple Probability Calculations {.smaller}
...
**Interpretation:** (a) 48.98% of values fall between the mean and z = 2.32; (b) 95.05% fall below z = 1.65; (c) 2.81% fall above z = 1.91.

## Example 6-5: Finding a z Value Given an Area {.smaller}
...
## Example 6-6: Summer Spending {.smaller}
...
## Example 6-7: Newspaper Recycling {.smaller}
...
## Example 6-8: Coffee Consumption {.smaller}
...
# Probability of consuming less than 1 gallon
p <- pnorm(1, mean = mu, sd = sigma)
p

# Expected number in sample of 500
round(p * 500)
```

**Interpretation:** Only about **0.4%** of people drink less than 1 gallon — approximately **2 people** in a sample of 500.

## Example 6-9: Police Academy {.smaller}
...
## Example 6-10: Blood Pressure {.smaller}
...
mu <- 120; sigma <- 8
# Lower and upper bounds for middle 60%
...
## Example 6-11: Technology Inventories {.smaller}
...
**Answer:** z = 1.50, P(X > 132,500) ≈ **0.0668** (about 6.68%).

## Example 6-12: Baseball Game Duration {.smaller}
...
**Note:** z ≈ −0.81; P(X < 145) ≈ **0.2090** (approximately 20.9%). Since the data is skewed, this is only a rough estimate.
...
As sample size **n** increases, the sampling distribution of the sample mean $\bar{X}$ approaches a **normal distribution**, regardless of the shape of the population distribution, provided n is sufficiently large (typically **n ≥ 30**).
...
## Example 6-13: Children's TV Viewing {.smaller}
...
## Example 6-14: Vehicle Age {.smaller}
...
## Example 6-16: Reading While Driving {.smaller}
...
**Parameters:** μ = np = 18, σ = √(npq) = √(300 × 0.06 × 0.94)
...
**Answer (normal approx.):** ≈ **0.0227** (2.27%); Exact binomial: ≈ 0.0220.

## Example 6-17: Widowed Bowlers {.smaller}
...
**Check:** np = 20 ≥ 5, nq = 180 ≥ 5 ✓

**Parameters:** μ = 20, σ = √(200 × 0.10 × 0.90) = √18
...
**Answer:** ≈ **0.9934** (99.34%) — it is extremely likely that 10 or more widowed bowlers appear in such a sample.

## Example 6-18: Batting Averages {.smaller}
...
**Check:** np = 32 ≥ 5, nq = 68 ≥ 5 ✓

**Parameters:** μ = 32, σ = √(100 × 0.32 × 0.68)
...
**Answer (normal approx.):** ≈ **0.119** (11.9%); Exact: ≈ 0.116.

## Example 6-19: Comparing Binomial and Normal Approximation {.smaller}
...
| Normal approx. to binomial | μ=np, σ=√(npq) | ±0.5 correction |
...
4. Use normal approximation to binomial when np ≥ 5 **and** nq ≥ 5
